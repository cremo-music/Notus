...
class FrereJacquesController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func playAction(_ sender: UIButton) {
        do {
            delegate.playAction(play: !sender.isSelected, button: sender, song: try frereJacques())
    ...
    private func song() throws -> (Music, UserPatchMap) {
        let (music, upm) = try frereJacques()        
